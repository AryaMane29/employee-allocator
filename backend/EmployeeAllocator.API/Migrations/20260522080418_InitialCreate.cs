        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiredTechnologies = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "admin@allocator.com", "$2a$11$9e8V9sGvKkMfQv6BB7.OneC24paeplFa6NvzoJMRMvpTGELMaIO9K", "admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectAllocations_ProjectId_EmployeeId",
                table: "ProjectAllocations",
